...
def get_comment(url, time_filter):
    ...
    # 定位到评论
    rexp = re.compile(r'articleh normal_post.*') # 有两种 articleh normal_post article normal_post odd
...
# url = 'http://fund.eastmoney.com/company/80053708.html'  # 汇添富
...
for fund in htf_funds:
    ...
    # 重定向不需要再requests.get，浪费资源，直接替换字符串就行
    # guba_resp.close()
    guba_url =  re.sub(r'fund.eastmoney.com/ba', 'guba.eastmoney.com', fund_guba)
